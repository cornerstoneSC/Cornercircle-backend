...
public class AdminAuthService {
    ...
    @Transactional(readOnly=true) public List<AdminSummary> list(){return credentials.findAll().stream().sorted(Comparator.comparing(AdminCredential::getDisplayName,String.CASE_INSENSITIVE_ORDER)).map(AdminSummary::from).toList();}
